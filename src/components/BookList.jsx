...
export default function BookList() {
  ...
  useEffect(() => {
    axios
      .get("https://node56510-env-8245251.proen.app.ruk-com.cloud/books")
      .then((response) => {
  ...
  const viewBook = (id) => {
    axios
      .get(`https://node56510-env-8245251.proen.app.ruk-com.cloud/books/${id}`)
      .then((response) => {
  ...
  const deleteBook = (id) => {
    axios
      .delete(`http://node56510-env-8245251.proen.app.ruk-com.cloud/books/${id}`)
      .then(() => {
